...
<head>
    ...
    <title>Mohan's DevOps Lab</title>
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Mohan's DevOps AWS Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Hello</h1>
        <p>This is Mohans Sai DevOps AWS Lab</p>
...
<div class="container">
    ...
    <footer>
        <p>&copy; Mohans devops lab 2020-2021</p>
    </footer>
</div> <!-- /container -->
